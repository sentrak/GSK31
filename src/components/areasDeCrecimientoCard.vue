<template>
  <div id="layout">
    ...
    <div
      ...
      :elevation="5"
      color="#000233"
      @click="area_de_crecimiento.show = !area_de_crecimiento.show"
      max-width="100%"
    ...
    >
      <div
        id="imagen_estado"
        v-if="area_de_crecimiento.estado == true"
      ...
      <div
        id="imagen_estado"
        v-if="area_de_crecimiento.estado == false"
      ...
      <div id="derecha">
        ...
        <p id="sub_titulo">{{ cambio_texto(area_de_crecimiento.estado) }}</p>
      </div>
      <br />
      <!------------------------------------------------------------------------------------------------------------ -->
      <v-card-actions>
      ...
      <v-expand-transition>
        <div v-show="area_de_crecimiento.show">
          <v-divider></v-divider>
          <div
            id="card_requisito"
            :elevation="5"
          ...
          >
            ...
            <v-btn
              ...
              text
              v-on:click="
                peticion_integrante(requisito._id, area_de_crecimiento.tipo)
              "
            ...
            <v-btn
              ...
              text
              v-on:click="
                realizado_a_no_realizado(
                  requisito._id,
                  area_de_crecimiento.tipo
                )
              "
              >Aceptar</v-btn
            >
            ...
            <v-btn
              ...
              text
              v-on:click="
                rechazar_peticion(requisito._id, area_de_crecimiento.tipo)
              "
            ...
            <v-btn
              ...
              text
              v-on:click="
                aceptar_peticion(requisito._id, area_de_crecimiento.tipo)
              "
...
export default {
  ...
  methods: {
    ...
    ponerdatos() {
      for (let i = 0; i < this.areas_de_crecimientos.length; i++) {
        this.$set(this.areas_de_crecimientos[i], "show", false);
      }
    },
  },
